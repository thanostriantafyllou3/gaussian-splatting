...
if __name__ == '__main__':
    ...
    train_imgs = [2, 16, 26, 55, 73, 75, 86, 93]
    test_imgs = [i for i in range(0, 200, 8)]
    print(test_imgs)

    # SPECIFY THE SOURCE AND DESTINATION DIRECTORIES FOR THE TRAIN/TEST IMAGES
    src_dir = '/home/thanostriantafyllou/gaussian-splatting/data/nerf_synthetic/ship'
    dst_dir = '/home/thanostriantafyllou/gaussian-splatting/data/free_nerf_runs/ship_8v'
